...
但是这种方式已经被废弃不推荐使用，因为@babel/polyfill包比较大，整体引入既增加项目体积，又污染了过多的全局环境，所以现在推荐使用preset-env来按需引入polyfill。
```javascript
// babel.config.js
module.exports = {
    presets: [
