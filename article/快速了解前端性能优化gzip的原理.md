通常在看一些面试题问到前端有哪些性能优化手段的时候，可能会提到一个叫做gzip压缩的方法。正好最近在学习node文件流操作和zlib模块的时候，对gzip压缩有了一个新的认识。今天就和大家一起分享学习一下，gzip是什么，工作原理，以及如何配置使用。相信看完这篇文章之后，你会不由自主的说，原来gzip是这么个玩意啊，太简单了。
